export const projects = [
  {
    ...
    challenges: '프로젝트를 진행하면서 성능 최적화와 상태 관리에 대한 도전 과제가 있었습니다. React의 최신 기능들을 활용하여 이를 해결했습니다.',
    learned: 'React Hooks, 성능 최적화 기법, 컴포넌트 재사용성에 대해 깊이 있게 학습할 수 있었습니다.'
  },
  {
    id: 2,
    title: '프로젝트 제목 2',
    ...
    challenges: '다양한 브라우저에서 일관된 디자인을 유지하는 것이 가장 큰 과제였습니다. CSS 변수와 모던 CSS 기법으로 이를 해결했습니다.',
    learned: 'CSS의 고급 기능들과 웹 표준, 접근성에 대한 이해를 높일 수 있었습니다.'
  },
  {
    id: 3,
    title: '프로젝트 제목 3',
    ...
    challenges: 'API 보안과 대용량 트래픽 처리가 주요 과제였습니다. 미들웨어 패턴과 캐싱 전략으로 해결했습니다.',
    learned: '백엔드 아키텍처 설계, 데이터베이스 최적화, API 보안에 대한 실무 경험을 쌓을 수 있었습니다.'
  }
]
